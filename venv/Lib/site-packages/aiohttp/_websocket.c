 ...
 */
    ...
    __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)(&PyBytes_Type)), __pyx_t_4, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 23, __pyx_L1_error)
 ...
 */
  /*else*/ {
    ...
    __pyx_t_4 = __Pyx_PyObject_Call(((PyObject *)(&PyByteArray_Type)), __pyx_t_5, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 28, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
 ...
 */
  ...
  __pyx_t_6 = PyByteArray_AsString(((PyObject*)__pyx_v_data)); if (unlikely(__pyx_t_6 == ((char *)NULL))) __PYX_ERR(0, 31, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_6 = PyBytes_AsString(__pyx_v_mask); if (unlikely(__pyx_t_6 == ((char *)NULL))) __PYX_ERR(0, 32, __pyx_L1_error)
...
static int __pyx_pymod_exec__websocket(PyObject *__pyx_pyinit_module)
#endif
#endif
{
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init aiohttp._websocket", 0, __pyx_lineno, __pyx_filename);
    }
